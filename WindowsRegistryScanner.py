...
def display_header():
  ...
  _____               _       _                   _____                                       
 |  __ \             (_)     | |                 / ____|                                      
 | |__) | ___   __ _  _  ___ | |_  _ __  _   _  | (___    ___  __ _  _ __   _ __    ___  _ __ 
 |  _  / / _ \ / _` || |/ __|| __|| '__|| | | |  \___ \  / __|/ _` || '_ \ | '_ \  / _ \| '__|
 | | \ \|  __/| (_| || |\__ \| |_ | |   | |_| |  ____) || (__| (_| || | | || | | ||  __/| |   
 |_|  \_\\___| \__, ||_||___/ \__||_|    \__, | |_____/  \___|\__,_||_| |_||_| |_| \___||_|   
                __/ |                     __/ |                                               
               |___/                     |___/                                                
             ...
             by Dr. Hussein Bakri\n""", 'green')
        cprint("WindowsRegistryScanner.py is licensed under MIT\n",'green')
...
def main():
	...
	if (args.enumerate == None and args.query == None):
		parser.print_help()
		exit(0)
	display_header()
